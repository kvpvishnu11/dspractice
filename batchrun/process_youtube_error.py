...
try:
    ...
    # Fetch 5 comments at a time where hatevalue is 'api-error'
    query = "SELECT comment_text, comment_id FROM comments WHERE hatevalue='api-error' LIMIT 1000"
    ...
    for comment_row in comments_to_process:
        ...
        update_query = "UPDATE comments SET hatevalue = %s WHERE comment_id = %s"
        try:
